...
CREATE TABLE `avaliacoes` (
  ...
  CONSTRAINT `avaliacoes_ibfk_1` FOREIGN KEY (`ProdutoID`) REFERENCES `produtos` (`ProdutoID`),
  CONSTRAINT `avaliacoes_ibfk_2` FOREIGN KEY (`ClienteID`) REFERENCES `clientes` (`ClienteID`)
