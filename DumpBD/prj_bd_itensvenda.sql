...
CREATE TABLE `itensvenda` (
  ...
  CONSTRAINT `itensvenda_ibfk_1` FOREIGN KEY (`VendaID`) REFERENCES `vendas` (`VendaID`),
  CONSTRAINT `itensvenda_ibfk_2` FOREIGN KEY (`ProdutoID`) REFERENCES `produtos` (`ProdutoID`)
