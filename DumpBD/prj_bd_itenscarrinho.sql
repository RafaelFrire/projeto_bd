...
CREATE TABLE `itenscarrinho` (
  ...
  CONSTRAINT `itenscarrinho_ibfk_1` FOREIGN KEY (`CarrinhoID`) REFERENCES `carrinhos` (`CarrinhoID`) ON UPDATE CASCADE,
  CONSTRAINT `itenscarrinho_ibfk_2` FOREIGN KEY (`ProdutoID`) REFERENCES `produtos` (`ProdutoID`) ON UPDATE CASCADE
...
-- Dump completed on 2024-06-24  0:09:42
